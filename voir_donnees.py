#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""Affichage complet de toutes les donnees dans centralisation_db"""
...
for coll_name in db.list_collection_names():
    ...
    if coll_name == 'curated_observations':
        ...
        for source in sources:
            ...
            # Exemples de donnees par cle
            print(f"\n   Detail par cle (top 20):")
            print(f"   {'Cle':<20} {'Observations':<15} {'Derniere valeur':<20} {'Date'}")
            print("   " + "-" * 90)
            ...
            if len(keys) > 20:
                print(f"   ... et {len(keys) - 20} autres cles")
    ...
    # Si ingestion_runs
        ...
        for source in sources:
            ...
            if last_run:
                print(f"   Derniere execution: {last_run.get('start_time')}")
